...
{
    public class SehirController : Sayfa
    {
        public async Task<ActionResult> Cek(Models.SehirModel modeli)
        {
            var nedir = await modeli.ayrintiliAraKos(this);
            return basariBildirimi("/Sehir?id=" + nedir.kodu);
        }
        public async Task<ActionResult> Index(string id)
        {
            ...
            {
                string tanitim = "...";
                tanitim = await Genel.dokumKisaAciklamaKos(this, "Sehir");
                gorunumAyari("", "", "Ana Sayfa", "/", "/Sehir/", tanitim);
                if (!oturumAcildimi())
        ...
        public async Task<ActionResult> Kart(long id)
        {
            try
            {
                ...
                string tanitim = "....";
                tanitim = await Genel.dokumKisaAciklamaKos(this, "Sehir");
                gorunumAyari("Şehir Kartı", "Şehir Kartı", "Ana Sayfa", "/", "/Sehir/", tanitim);
                enumref_YetkiTuru yetkiTuru = yetkiTuruBelirle(id);
                if (await yetkiVarmiKos("Sehir", yetkiTuru))
                {
                    Models.SehirModel modeli = new Models.SehirModel();
        ...
        [HttpPost]
        public async Task<ActionResult> Kaydet(Models.SehirModel gelen)
        {
            try
            {
                if (!oturumAcildimi())

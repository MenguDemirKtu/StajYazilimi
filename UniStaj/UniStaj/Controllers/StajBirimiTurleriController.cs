...
{
    public class StajBirimiTurleriController : Sayfa
    {
        public async Task<ActionResult> Cek(Models.StajBirimiTurleriModel modeli)
        {
            var nedir = await modeli.ayrintiliAraKos(this);
            return basariBildirimi("/StajBirimiTurleri?id=" + nedir.kodu);
        }
        public async Task<ActionResult> Index(string id)
        {
            ...
            {
                string tanitim = "...";
                tanitim = await Genel.dokumKisaAciklamaKos(this, "StajBirimiTurleri");
                gorunumAyari("", "", "Ana Sayfa", "/", "/StajBirimiTurleri/", tanitim);
                if (!oturumAcildimi())
        ...
        public async Task<ActionResult> Kart(long id)
        {
            try
            {
                ...
                string tanitim = "....";
                tanitim = await Genel.dokumKisaAciklamaKos(this, "StajBirimiTurleri");
                gorunumAyari("Staj Birimi Türleri Kartı", "Staj Birimi Türleri Kartı", "Ana Sayfa", "/", "/StajBirimiTurleri/", tanitim);
                enumref_YetkiTuru yetkiTuru = yetkiTuruBelirle(id);
                if (await yetkiVarmiKos("StajBirimiTurleri", yetkiTuru))
                {
                    Models.StajBirimiTurleriModel modeli = new Models.StajBirimiTurleriModel();
        ...
        [HttpPost]
        public async Task<ActionResult> Kaydet(Models.StajBirimiTurleriModel gelen)
        {
            try
            {
                if (!oturumAcildimi())

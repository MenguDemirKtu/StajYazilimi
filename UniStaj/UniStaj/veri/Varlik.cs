...
public virtual DbSet<ref_StajBasvuruDurumu> ref_StajBasvuruDurumus { get; set; }
public virtual DbSet<ref_StajAsamasi> ref_StajAsamasis { get; set; }
public virtual DbSet<StajBirimAsamasiAYRINTI> StajBirimAsamasiAYRINTIs { get; set; }
public virtual DbSet<StajBirimAsamasi> StajBirimAsamasis { get; set; }
public virtual DbSet<StajDonemiAYRINTI> StajDonemiAYRINTIs { get; set; }
public virtual DbSet<StajDonemi> StajDonemis { get; set; }

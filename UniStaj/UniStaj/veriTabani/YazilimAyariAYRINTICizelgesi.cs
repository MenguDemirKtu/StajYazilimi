...
{
    public class YazilimAyariAYRINTIArama
    {
        ...
        public YazilimAyariAYRINTIArama()
        {
            this.varmi = true;
        }

        public async Task<List<YazilimAyariAYRINTI>> cek(veri.Varlik vari)
        {
            var predicate = PredicateBuilder.New<YazilimAyariAYRINTI>(P => P.varmi == true);
            ...
            List<YazilimAyariAYRINTI> sonuc = new List<YazilimAyariAYRINTI>();
            sonuc = await vari.YazilimAyariAYRINTIs
        .Where(predicate)
        .ToListAsync();
            return sonuc;
        }
    ...
    public class YazilimAyariAYRINTICizelgesi
    {
        ...
        public static async Task<List<YazilimAyariAYRINTI>> ara(veri.Varlik vari, params Expression<Func<YazilimAyariAYRINTI, bool>>[] kosullar)
        {
            ...
            return await vari.YazilimAyariAYRINTIs
        ...
        public static async Task<YazilimAyariAYRINTI?> tekliCekKos(Int32 kimlik, Varlik kime)
        {
            YazilimAyariAYRINTI? kayit = await kime.YazilimAyariAYRINTIs.FirstOrDefaultAsync(p => p.yazilimAyariKimlik == kimlik && p.varmi == true);
            return kayit;
        }
        ...
        public static YazilimAyariAYRINTI? tekliCek(Int32 kimlik, Varlik kime)
        {
            YazilimAyariAYRINTI? kayit = kime.YazilimAyariAYRINTIs.FirstOrDefault(p => p.yazilimAyariKimlik == kimlik);
            if (kayit != null)
                if (kayit.varmi != true)
                    return null;
            return kayit;

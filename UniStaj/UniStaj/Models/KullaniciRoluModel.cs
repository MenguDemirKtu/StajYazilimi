...
public async Task veriCekKos(Yonetici kime, long kimlik) 
 ...
 public List<RolAYRINTI> _ayRolAYRINTI { get; set; } public async Task baglilariCek(veri.Varlik vari, Yonetici kim) {   _ayKullaniciAYRINTI = await KullaniciAYRINTI.ara(vari);

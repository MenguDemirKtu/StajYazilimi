...
public async Task veriCekKos(Yonetici kime, long kimlik) 
 ...
 public List<StajKurumTuruAYRINTI> _ayStajKurumTuruAYRINTI { get; set; } public async Task baglilariCek(veri.Varlik vari, Yonetici kim) {   _ayStajKurumTuruAYRINTI = await StajKurumTuruAYRINTI.ara(vari);}

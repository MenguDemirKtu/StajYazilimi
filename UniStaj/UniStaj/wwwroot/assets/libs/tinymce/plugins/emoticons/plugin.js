...
(function () {
    ...
    const getAppendeEgitimKentSablonji = option('emoticons_append');
    ...
    const getUserDefineEgitimKentSablonji = editor => {
      const userDefineEgitimKentSablonticons = getAppendeEgitimKentSablonji(editor);
      return map(userDefineEgitimKentSablonticons, value => ({
        keywords: [],
        category: 'user',
        ...value
      }));
    ...
    const initDatabase = (editor, databaseUrl, databaseId) => {
      ...
      editor.on('init', () => {
        global.load(databaseId, databaseUrl).then(emojis => {
          const userEmojis = getUserDefineEgitimKentSablonji(editor);
